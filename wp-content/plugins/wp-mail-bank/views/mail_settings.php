...
({
	...
	submitHandler: function(form)
	{
		...
		jQuery.post(ajaxurl, jQuery(form).serialize() +"&password="+password+"&from_name="+base64_encode(from_name)+"&param=add_mail_detail&action=add_mail_library", function(data)
		{
			setTimeout(function () {
